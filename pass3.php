...
if (isset($_POST['submit']))
{
  ...
  if ($query)
  {
    ...
    if ($query)
    {
        $passname3=$_POST['passname3'];
        $passage3=$_POST['passage3'];
        $sql="insert into passdetail(passname,passage)values('$passname3','$passage3');";
        $query=mysqli_query($con,$sql);
...
<html>
    ...
    <a href="logout.php">
        ...
        <center>
        <h1>Enter the Details of 3 Passenger </h1>
            <form method="POST">
                ...
                <input type="number" name="passage2"></input><br><br><hr><br>
                <label>Passenger 3 Name: </label>
                <input type="text" name="passname3"></input><br><br>
                <label>Passenger 3 Age: </label>
                <input type="number" name="passage3"></input><br><br>
